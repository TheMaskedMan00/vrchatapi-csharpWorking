...
namespace VRChat.API.Model
{
    ...
    public partial class SentNotification : IEquatable<SentNotification>, IValidatableObject
    {
        ...
        /// <param name="recieverUserId">A users unique ID, usually in the form of &#x60;usr_c1644b5b-3ca4-45b4-97c6-a2a0de70d469&#x60;. Legacy players can have old IDs in the form of &#x60;8JoV9XEdpo&#x60;. The ID can never be changed..</param>
        ...
        public SentNotification(DateTime createdAt = default(DateTime), NotificationDetails details = default(NotificationDetails), string id = default(string), string message = default(string), string recieverUserId = default(string), string senderUserId = default(string), string senderUsername = default(string), NotificationType? type = default(NotificationType?))
        {
        ...
        [DataMember(Name = "recieverUserId", EmitDefaultValue = false)]
