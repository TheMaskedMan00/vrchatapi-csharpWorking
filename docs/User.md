...
------------ | ------------- | ------------- | -------------
**AllowAvatarCopying** | **bool** |  | [optional] [default to true]
...
**DisplayName** | **string** | A users visual display name. This is what shows up in-game, and can different from their &#x60;username&#x60;. Changing display name is restricted to a cooldown period. | [optional] 
...
**IsFriend** | **bool** | Either their &#x60;friendKey&#x60;, or empty string if you are not friends. Unknown usage. | [optional] 
**LastActivity** | **string** | Either a date-time or empty string. | [optional] 
**LastLogin** | **string** | Either a date-time or empty string. | [optional] 
